...
def get_graph_results(data_root_dir, model, dataset, gid_list, name='train', num_feature=7):
    ...
    fig = px.scatter(resultdf, x='tsne_x', y='tsne_y', color='error_trace_type', hover_name='trace_id',
...
def add_tsne_embedding(resultdf, name='train', num_feature=7):
    ...
    fig = px.scatter(resultdf, x='tsne_x', y='tsne_y', color='trace_bool', hover_name='trace_id',

...
#     another dataset
#     """
#     def __init__(self, node_feature_path, edge_index_csv=None, node_type_txt=None, transform=None, **kwargs):
#         """
#         node_feature_csv: path to the node feature csv file
#         het_neigh_root: path to the het neighbour list root dir
#         """
...
#         self.node_feature_fname = '{node_feature_path}/node_feature_parts/node_feature_norm_g{gid}.csv'
...
#                 graph_het_feature: (n_neigh, n_node, topk, n_feature)
#         """
#         node_feature_numpy = pd.read_csv(f'{self.node_feature_path}/node_feature_parts/node_feature_norm_g{gid}.csv') \
#             .sort_values(['trace_id', 'node_id']).iloc[:, 2:].values
#         graph_node_feature = torch.from_numpy(node_feature_numpy).float().to(self.device)

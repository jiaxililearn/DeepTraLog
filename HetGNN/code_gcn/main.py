...
@click.option('--augmentation_method', default='edge_perturbation', type=str, help='graph augment method')
@click.option('--edge_ratio_percentile', default=0.95, type=float, help='percentile used for edge perturbation')
@click.option('--edge_mutate_prob', default=None, type=float, help='probability if an edge should be mutated')
@click.option('--add_method', default='rare', type=str, help='edge addition method. rare | simple')
...
def main(**args):
    ...
    elif args['trainer_version'] == 3:
        from train_3 import Train3 as Train
    else:
